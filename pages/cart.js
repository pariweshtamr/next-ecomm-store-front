    ...
    <Layout>
      <div className="w-[85%] m-[0_auto] py-20">
        {!cartItems?.length ? (
          ...
          <>
            <h2 className="font-bold text-3xl mb-5">Cart</h2>
            <div className="grid grid-cols-[1.3fr_0.7fr] gap-10 md:grid-cols-1">
                  ...
                  <table className="basic">
                    ...
                    <tbody>
                      {products.map((product) => (
                        <tr key={product?._id}>
                          <td>
                            <div className="w-[120px] h-[120px] border border-solid border-[rgba(0,0,0,0.1)] rounded-md flex items-center justify-center sm:w-[70px] sm:h-[60px]">
                              <Image
                                src={product.images[0]}
                                alt="pro-img"
                                className="max-w-[90px] max-h-[90px] sm:max-w-[50px] sm:max-h-[50px]"
                                width={1000}
                                height={1000}
                              />
                            </div>
                          ...
                          <td className="">
                            <button
                              className="btn-secondary sm:p-1 sm:px-2"
                            ...
                            <button
                              className="btn-success sm:p-1 sm:px-2"
